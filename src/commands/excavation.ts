...
async function attempt_mining(instance: MineflayerBot, args: Args): Promise<void> {
  ...
  if (!block) return
    ...
    if (instance.getStates().isMining) {
      instance.log(instance.strings.msg_miner_already_started)
      return
    }
    ...
    if (!mcData.blocksByName[block]) {
      instance.log(instance.strings.msg_finder_block_success)
      return
    }
    ...
    instance.log(instance.strings.msg_miner_start_success)
...
async function mining(instance: MineflayerBot): Promise<void> {
    ...
    if (instance.getStates().stopMining) {
        ...
        instance.log(instance.strings.msg_miner_stopped)
        return
      }
